import 'package:beit_alnakha_admin/core/responsive_helper/responsive_font_size.dart';
...
abstract class AppStyles {
  ...
  static TextStyle regular13(BuildContext context) {
    return TextStyle(
      ...
      fontFamily: 'cairo',
      fontSize: ResponsiveFontSize.getResponsiveFontSize(context, 13),
      fontWeight: FontWeight.w400,
    );
  }
  ...
  static TextStyle regular10(BuildContext context) {
    return TextStyle(
      color: AppColors.white,
      fontFamily: 'cairo',
      fontSize: ResponsiveFontSize.getResponsiveFontSize(context, 10),
      fontWeight: FontWeight.w400,
    );
  }
  ...
  static TextStyle medium15(BuildContext context) {
    return TextStyle(
      color: AppColors.grey7A,
      fontFamily: 'cairo',
      fontSize: ResponsiveFontSize.getResponsiveFontSize(context, 15),
      fontWeight: FontWeight.w500,
    );
  }
