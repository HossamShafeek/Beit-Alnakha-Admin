class AppStrings {
  ...
  static const String newText = 'جديد';
  ...
  static const String canceledForTabBar = 'ملغي';
  ...
  static List<String> requestsStatusForTabBar = [
    all,
    preparing,
    prepared,
    delivering,
  ...
  static List<String> columnsNameForRequestsDataTable = [
    hash,
    requestsNumber,
    customerName,
    date,
