...
abstract class AppAssets {
  // Svg Images
  static const String hide = '${AppConstants.pathForSvg}hide.svg';
  ...
  static const String arrowDown = '${AppConstants.pathForSvg}arrow_down.svg';
  static const String delete = '${AppConstants.pathForSvg}delete.svg';
  static const String switchIcon = '${AppConstants.pathForSvg}switch.svg';
  static const String call = '${AppConstants.pathForSvg}call.svg';
  static const String edit = '${AppConstants.pathForSvg}edit.svg';
  static const String logout = '${AppConstants.pathForSvg}logout.svg';
  ...
  static const String prepared = '${AppConstants.pathForSvg}prepared.svg';
  static const String status = '${AppConstants.pathForSvg}status.svg';
  static const String users = '${AppConstants.pathForSvg}users.svg';
  static const String user = '${AppConstants.pathForSvg}user.svg';
  static const String activeUser = '${AppConstants.pathForSvg}active_user.svg';
  ...
  static const String dollar = '${AppConstants.pathForSvg}dollar.svg';
  ...
  static const String loginBg = '${AppConstants.pathForImages}login_bg.png';
  static const String loginLogo = '${AppConstants.pathForImages}login_logo.png';
  static const String emptyImage =
      '${AppConstants.pathForImages}empty_image.png';
  static const String noUser = '${AppConstants.pathForImages}no_user.png';

  // Lottie
  static const String loading = '${AppConstants.pathForLottie}loading.json';
  static const String horizontalLoading =
      '${AppConstants.pathForLottie}horizontal_loading.json';
}
