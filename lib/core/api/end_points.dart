class EndPoints {
  static const String baseUrl = 'https://flavor-house.md-iraqsoft.com/api/v1';
  //static const String baseUrl = 'http://192.168.1.205:5674/api/';
  static const String login = '/auth/login';
  static const String getDepartments = '/category';
  static const String cities = '/governorate';
  ...
  static const String sliders = '/slider';
}
