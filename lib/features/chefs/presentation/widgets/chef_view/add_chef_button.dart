...
import 'package:beit_alnakha_admin/features/chefs/presentation/views/add_chef_view.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class AddChefButton extends StatelessWidget {
  const AddChefButton({super.key});
  ...
  Widget build(BuildContext context) {
    if (context.width < ScreenWidthBreakpoints.desktop) {
      return CustomContainerButton(
        ...
        onTap: () {
          showAddChefDialog(context: context);
        },
      );
    } else {
  ...
  void showAddChefDialog({required BuildContext context}) {
    showDialog(
      context: context,
      builder: (context) {
        return AddChefView();
