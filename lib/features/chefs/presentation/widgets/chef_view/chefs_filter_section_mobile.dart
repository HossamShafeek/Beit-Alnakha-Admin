...
class ChefsFilterSectionMobile extends StatelessWidget {
  const ChefsFilterSectionMobile({super.key});
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(AppStrings.chefsMenu, style: AppStyles.semiBold20(context)),
            ],
          ),
          Row(
            spacing: AppSize.size8,
            children: [
              Expanded(child: ChefsSearchField()),
              AddChefButton(),
            ],
          ),
        ],
