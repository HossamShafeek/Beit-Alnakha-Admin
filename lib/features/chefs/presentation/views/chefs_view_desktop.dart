...
import 'package:beit_alnakha_admin/features/chefs/presentation/widgets/chef_view/chefs_filter_section_desktop.dart';
import 'package:beit_alnakha_admin/features/chefs/presentation/widgets/chef_view/chefs_tab_bar.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';

class ChefsViewDesktop extends StatelessWidget {
  const ChefsViewDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        ChefsFilterSectionDesktop().toSliver(),
        SliverGap(AppSize.size16),
