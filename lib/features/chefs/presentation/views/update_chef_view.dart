...
import 'package:beit_alnakha_admin/features/chefs/presentation/widgets/chef_view/add_chef_texts_fields_section.dart';
import 'package:flutter/material.dart';

class UpdateChefView extends StatelessWidget {
  const UpdateChefView({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                PicPhotoWidget(title: AppStrings.pressToUploadChefImage),
                AddChefTextsFieldsSection(),
              ],
            ),
          ),
        ),
