...
import 'package:beit_alnakha_admin/features/customers/presentation/widgets/customers_filter_section_mobile.dart';
...
class CustomersViewMobile extends StatelessWidget {
  const CustomersViewMobile({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverGap(AppSize.size16),
        CustomersFilterSectionMobile().toSliver(),
        SliverGap(AppSize.size16),
