...
class CustomerDetailsDataSectionAppBar extends StatelessWidget {
  const CustomerDetailsDataSectionAppBar({super.key});
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text('حسام شفيق', style: AppStyles.medium16(context)),
              Row(
