...
import 'package:beit_alnakha_admin/features/departments/presentation/widgets/departments_view/departments_filter_section_desktop.dart';
...
class DepartmentsViewDesktop extends StatelessWidget {
  const DepartmentsViewDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        DepartmentsFilterSectionDesktop().toSliver(),
        SliverGap(AppSize.size16),
