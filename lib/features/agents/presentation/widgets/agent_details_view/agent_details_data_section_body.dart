...
class AgentDetailsDataSectionBody extends StatelessWidget {
  const AgentDetailsDataSectionBody({super.key});
  ...
  Widget build(BuildContext context) {
    return ResponsivePatternLayout(
      ...
      children: [
        ...
        CustomListTile(
          svgIconPath: AppAssets.coupon,
          titleText: AppStrings.agentCode,
          trailingTitle: '07777777777',
        ),
        CustomListTile(
