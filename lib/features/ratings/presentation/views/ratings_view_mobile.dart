...
import 'package:beit_alnakha_admin/features/ratings/presentation/widgets/ratings_view/ratings_filter_section_mobile.dart';
...
class RatingsViewMobile extends StatelessWidget {
  const RatingsViewMobile({super.key});
    ...
    return Padding(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          RatingsFilterSectionMobile().toSliver(),
          SliverGap(AppSize.size16),
