...
import 'package:beit_alnakha_admin/features/meals/presentation/widgets/meals_view/meals_filter_section_mobile.dart';
import 'package:beit_alnakha_admin/features/meals/presentation/widgets/meals_view/meals_tab_bar.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';

class MealsViewMobile extends StatelessWidget {
  const MealsViewMobile({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        MealsFilterSectionMobile().toSliver(),
        SliverGap(AppSize.size16),
