...
import 'package:beit_alnakha_admin/features/awards/presentation/widgets/awards_view/awards_filter_section_mobile.dart';
...
class AwardsViewMobile extends StatelessWidget {
  const AwardsViewMobile({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverGap(AppSize.size16),
        AwardsFilterSectionMobile().toSliver(),
        SliverGap(AppSize.size16),
