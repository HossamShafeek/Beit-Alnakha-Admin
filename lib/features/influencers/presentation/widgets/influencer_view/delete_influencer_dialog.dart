...
class DeleteInfluencerDialog extends StatelessWidget {
  const DeleteInfluencerDialog({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomDialog(
      ...
      title: AppStrings.deleteInfluencer,
      subtitle: AppStrings.youAreSureDeleteInfluencer,
    );
  }
}
