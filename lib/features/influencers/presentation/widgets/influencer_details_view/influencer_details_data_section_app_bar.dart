...
import 'package:beit_alnakha_admin/features/influencers/presentation/views/influencer_account_statement_view.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class InfluencerDetailsDataSectionAppBar extends StatelessWidget {
  const InfluencerDetailsDataSectionAppBar({super.key});
  ...
  void showAccountStatementDialog({required BuildContext context}) {
    showDialog(
      context: context,
      builder: (context) {
        return InfluencerAccountStatementView();
      },
    );
  }
}
