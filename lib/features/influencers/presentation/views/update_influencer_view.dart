...
class UpdateInfluencerView extends StatelessWidget {
  const UpdateInfluencerView({super.key});

  @override
  Widget build(BuildContext context) {
    return CustomResponsiveDialog(
      title: AppStrings.updateInfluencer,
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              PicPhotoWidget(title: AppStrings.pressToUploadInfluencerImage),
