...
import 'package:beit_alnakha_admin/features/influencers/presentation/widgets/influencer_view/influencers_filter_section_mobile.dart';
...
class InfluencersViewMobile extends StatelessWidget {
  const InfluencersViewMobile({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverGap(AppSize.size16),
        InfluencersFilterSectionMobile().toSliver(),
        SliverGap(AppSize.size16),
