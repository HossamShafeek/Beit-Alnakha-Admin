...
class DriverDetailsStatisticsData extends StatelessWidget {
  const DriverDetailsStatisticsData({super.key});
  ...
  final List<int> driverDetailsStatusValues = const [10,500,5,50000];
      ...
      children: driverStatusIcon
          ...
          .map(
            (e) => StatisticsDataItem(
              imagePath: e.value,
              subtitle: AppStrings.driverDetailsStatusForStatistics[e.key],
